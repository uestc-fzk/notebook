...
| --------------------------------------- | ---------- | ---------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 中间件：Kafka                           | 2022-04-11 | 2022-04-30 | kafka基础：[2022-04-11, 2022-04-23]<br />kraft集群模式：2022-04-24<br />kafka源码：[2022-04-25, 2022-04-30] | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> |                                                              |
| 中间件：RocketMQ                        | 2022-05-10 | 2022-06-12 | 买书《RocketMQ技术内幕》：2022-05-09<br />RocketMQ概念、集群、监控：[2022-05-10, 2022-05-13]<br />RocketMQ生产者、broker、消费者源码基本分析完成[2022-05-14,2022-06-12] | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> | 要做技术分享，所以绘制了很多流程图导致进度变慢               |
| 中间件：ElasticSearch                   |            |            |                                                              | <button style="background-color: #555555;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">挂起</button> |                                                              |
...
| 书籍：《MySQL技术内幕》                 | 2022-05-01 | 2022-05-18 | 买书：2022-04-23<br />开始：2022-05-01<br />看完：2022-05-18 | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> | 一共10章，看了2章，<br />浏览了2章，有2章没看：<br />《备份与恢复》<br />《InnoDB存储引擎源代码》 |
| 书籍：《Redis深度历险》                 |            |            | 买书：2022-04-23                                             | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> | 把Redis文档看完，书也看完了                                  |
| 分布式：《深入理解分布式事务》          | 2022-12-05 | 2022-12-25 | 买书：2022-04-23                                             | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> |                                                              |
...
| I/O：学习tomcat与netty                  |            |            |                                                              | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> | [极客tomcat课程](https://time.geekbang.org/column/article/115471) |
| 数据库：Postgresql文档阅读              |            |            |                                                              | <button style="background-color: #555555;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">挂起</button> |                                                              |
| 数据库：MySQL文档阅读+极客时间MySQL45讲 | 2022-12-26 |            | 数据类型、日志、备份、优化文档：[2022-12-26,2023-01-15]      |                                                              |                                                              |
| 中间件：MyCat或ShardingSphere           |            |            |                                                              |                                                              |                                                              |
| 中间件：Apollo                          |            |            |                                                              |                                                              |                                                              |
| 协议：FTP协议、文件上传、断点续传       |            |            |                                                              |                                                              |                                                              |
| 数据结构：实现文件B+树索引              | 2023-01-16 |            | B+树插入删除合并：[01-16,01-19]<br />文件如何实现呢???       |                                                              |                                                              |
| 协议：实现HTTP协议解析                  | 2023-01-01 | 2023-01-10 | 简单解析和响应：[2023-01-03,2023-01-04]<br/>ChannelHandler机制和Content-Type消息转换器：[2023-01-09,2023-01-10] | <button style="background-color: #4CAF50;border: none;border-radius: 5px;color: white;padding: 2px 20px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">done</button> |                                                              |
| task                                    | startDate  | endDate    | log                                                          | status | note                                                         |
| --------------------------------------- | ---------- | ---------- | ------------------------------------------------------------ | ------ | ------------------------------------------------------------ |
...
| 分布式：《深入理解分布式事务》          |            |            | 买书：2022-04-23                                             | done   |                                                              |
| 权限：了解casbin                        |            |            |                                                              |        |                                                              |
| I/O：学习netty                          |            |            |                                                              | done   | 这个最好结合源码学习                                         |
| 数据库：Postgresql文档阅读              |            |            |                                                              |        |                                                              |
| 数据库：MySQL文档阅读+极客时间MySQL45讲 | 2022-12-26 |            |                                                              |        |                                                              |
| 中间件：MyCat或ShardingSphere           |            |            |                                                              |        |                                                              |
| 中间件：Apollo                          |            |            |                                                              |        |                                                              |
| 协议：FTP协议、文件上传、断点续传       |            |            |                                                              |        |                                                              |
| Java实现文件B+树索引                    |            |            |                                                              | ing    |                                                              |
