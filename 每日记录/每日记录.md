...
| ----------------------------- | ---------- | ------- | ----------------- | ------------------------------------------------------------ | ---- |
| 中间件：Kafka学习使用         | 2022-04-11 |         |                   | <button style="background-color: #f44336;border: none;border-radius: 5px;color: white;padding: 2px 10px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">learning</button> |      |
...
| 开发：了解DDD领域驱动开发     |            |         |                   | <button style="background-color: #e7e7e7;border: none;border-radius: 5px;color: white;padding: 2px 10px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">created</button> |      |
...
| 书籍：《Redis核心原理与实践》 |            |         |                   | <button style="background-color: #e7e7e7;border: none;border-radius: 5px;color: white;padding: 2px 10px;text-align: center;text-decoration: none;display: inline-block;font-size: 12px;margin: 1px 1px;cursor: pointer;">created</button> |      |
...
|           |                                                              |                                                  |
| 4.18-4.24 | ~~1.【继续】kafka学习~~<br />2.【继续】k8s学习：继续阅读kubernetes文档<br />3.了解DDD领域驱动开发 |                                                  |
